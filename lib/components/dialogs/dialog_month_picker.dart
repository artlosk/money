...
Future<DateTime?> dialogMonthPicker({
...
class _MonthPickerDialogState extends State<_MonthPickerDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    var header = buildHeader(theme, locale, widget.round);
    var pager = buildPager(theme, locale);
    var content = Material(
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.only(
          bottomLeft: Radius.circular(widget.round ?? 0.0),
          bottomRight: Radius.circular(widget.round ?? 0.0),
        ),
      ),
      child: Column(
    ...
    return Theme(
      data: Theme.of(context).copyWith(
          ...
          accentColor: const Color(0xFF9053EB)),
      child: Dialog(
        child: Column(
  ...
  Widget buildHeader(ThemeData theme, String locale, double? round) {
    return Material(
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.only(
          topLeft: Radius.circular(round ?? 0.0),
          topRight: Radius.circular(round ?? 0.0),
        ),
      ),
